    ...
    <div className="image-listing">
      {
        ...
        {
          return (<div key={image.caption} className={i===active ? "active":""} onClick={()=>handleImageClick(i)}><img src={image.image_url} alt={image.caption}/></div>)
        })
      }
    </div>
       <Modal show={open} onClose={onClose} title={"modal"}>
         <SlideShow images={images} active={active} onNext={onNext} onPrev={onPrev}/> 
       </Modal>
    </div>
  )
}
